...
//!
//! 本模块所有“逻辑尺寸”都指 CSS 像素,与设计稿基准 370×455 同单位。
...
const DESIGN_W: f64 = 370.0;
const DESIGN_H: f64 = 455.0;
...
/// - 无历史尺寸:按显示器逻辑尺寸相对 1080p 基准缩放(1080p→1.0→370×455,与现状一致)。
...
/// 有保存尺寸就恢复其物理值,否则 370×455 逻辑尺寸;位置交给系统居中。
